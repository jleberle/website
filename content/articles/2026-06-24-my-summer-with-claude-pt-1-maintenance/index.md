...
Then I had Claude write four themes for NetNewsWire, my trusted RSS reader that allows custom themes. The [four themes](https://github.com/jleberle/nnw-themes) are divided into two categories: phone-based and desktop-based. Each one gets a minimal sans-serif theme and a serif theme. The sans-serif theme is kept very minimal and monochrome and has become my preferred themes over the slightly more elaborate serif themes.
